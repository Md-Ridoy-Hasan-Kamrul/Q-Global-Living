...
export default function DeveloperCTA({ onListProject }) {
  ...
  return (
    <section className='w-full my-16'>
      <div
        className='flex flex-col md:flex-row min-h-[280px] gap-6 bg-cover bg-center bg-no-repeat rounded-xl items-center justify-between p-8 md:p-12 text-center md:text-left'
        style={{
      ...
      >
        ...
        <div className='flex flex-col gap-2 max-w-2xl'>
          <h2 className='text-white text-3xl font-black leading-tight tracking-[-0.033em] sm:text-4xl'>
            {t('newDevelopments.developerCta.title')}
          </h2>
          <p className='text-gray-200 text-base font-normal leading-normal'>
        ...
        <button
          onClick={handleClick}
          className='flex min-w-40 max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-accent text-navy text-base font-bold leading-normal tracking-[0.015em] hover:opacity-90 whitespace-nowrap transition-opacity'
