...
export default function RentalPropertyCard({ property }) {
  ...
  return (
    <article
      className='flex flex-col gap-3 rounded-xl bg-[#fafafa] dark:bg-card-dark shadow-md border border-gray-100 dark:border-border-dark overflow-hidden group hover:shadow-xl transition-all duration-300 hover:-translate-y-1'
