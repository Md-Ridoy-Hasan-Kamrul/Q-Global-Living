  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex flex-col items-end">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-xs mt-0.5">{user?.user?.role || user?.role || "Member"}</p>
      </div>

      {/* avatar button */}
      <button
        onClick={() => setOpen((prev) => !prev)}
        className="relative flex items-center justify-center w-11 h-11 rounded-full overflow-hidden border-2 border-gray-200 dark:border-gray-700 hover:border-[#C5A572] dark:hover:border-[#C5A572] transition-all duration-200 group bg-gray-100 dark:bg-gray-800"
      >
      ...
      >
        ...
        <div className="px-4 py-3 bg-linear-to-br from-gray-50 to-white dark:from-[#1A2B42] dark:to-[#0F1B2E] border-b border-gray-100 dark:border-gray-700">
