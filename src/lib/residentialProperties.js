import { TrendingUp, Building, Shield, Waves, Dumbbell, TreePine, Smile } from 'lucide-react';
...
export const RESIDENTIAL_PROPERTIES = [
  ...
  },
  {
    ...
    paymentPlan: [
      ...
      { step: 2, title: 'Construction Milestone 1', detail: '25% on foundation completion' },
      { step: 3, title: 'Construction Milestone 2', detail: '25% on structural completion' },
      { step: 4, title: 'Handover', detail: '35% on completion & key handover' }
    ]
  },
  {
    id: '3',
    ...
    paymentPlan: [
      { step: 1, title: 'Reservation', detail: '10% on booking' },
      { step: 2, title: 'Construction Milestone 1', detail: '20% on foundation completion' },
      { step: 3, title: 'Construction Milestone 2', detail: '30% on structural completion' },
      { step: 4, title: 'Handover', detail: '40% on completion & key handover' }
    ]
  }
];
